...
int main()
{
  ...
  while (1)
  {
    ...
    else if (strncmp(cmd, "LOCAL", 5) == 0) //all commands starting with "ECHO" will print in the terminal now
    {
      dup2(d,1); // The standard output will be passed back to the terminal
